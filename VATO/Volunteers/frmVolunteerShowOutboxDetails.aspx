<%@ Page Language="C#" MasterPageFile="~/Volunteers/VolunteerMasterPage.master" AutoEventWireup="true" CodeFile="frmVolunteerShowOutboxDetails.aspx.cs" Inherits="Volunteers_frmVolunteerShowOutboxDetails" Title="Untitled Page" %>
    ...
    <center>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <tr>
                <td align="left">
                    <h4>
                        <a href="frmVolunteerOutbox.aspx">Back</a>
                    </h4>
                </td>
            </tr>
            <tr>
