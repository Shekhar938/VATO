<%@ Page Language="C#" MasterPageFile="~/Volunteers/VolunteerMasterPage.master" AutoEventWireup="true" CodeFile="frmForumDiscussionDetails.aspx.cs" Inherits="Members_ForumDiscussionDetails" Title="Untitled Page" %>
            ...
            <tr>
                <td>
                    <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False"
                        ...
                        <FooterStyle BackColor="#173D15" Font-Bold="True" ForeColor="White" />
...
<asp:LinkButton ID="linkdiscussionmaster" runat="server" ForeColor="White" PostBackUrl="~/Members/frmMemberDiscussionforumMaster.aspx">Post a Question</asp:LinkButton>
                        ...
                        <PagerStyle BackColor="#173D15" ForeColor="White" HorizontalAlign="Center" />
                        <SelectedRowStyle BackColor="#C5BBAF" Font-Bold="True" ForeColor="#173D15" />
