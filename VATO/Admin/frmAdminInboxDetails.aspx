<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="frmAdminInboxDetails.aspx.cs" Inherits="Admin_frmAdminInboxDetails" Title="Untitled Page" %>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            <tr>
                <td bgcolor="#E7B642" style="background-color: #173D15">
                    <br style="background-color: #173D15" />
                    <center class="style5">
                        &nbsp;InBox Details
                    </center>
                </td>
