<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="FrmAdminShowEmailDetailsOutbox.aspx.cs" Inherits="Admin_FrmAdminShowEmailDetailsOutbox" Title="Untitled Page" %>
    ...
    <center>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <tr>
                <td align="left">
                    <h4>
                        <a href="frmAdminOutbox.aspx">Back</a>
                    </h4>
                </td>
            </tr>
            <tr>
