<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ReportsDonorDetails.aspx.cs" Inherits="Admin_ReportsPayments" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="getDonorsReport" SelectCommandType="StoredProcedure">
        </asp:SqlDataSource>
    </div>
    </center>
</asp:Content>
