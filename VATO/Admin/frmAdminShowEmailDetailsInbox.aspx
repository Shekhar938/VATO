<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="frmAdminShowEmailDetailsInbox.aspx.cs" Inherits="Admin_frmAdminShowEmailDetailsInbox" Title="Untitled Page" %>
    ...
    <center>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <tr>
                <td align="left">
                    <h4>
                        <a href="frmAdminInboxDetails.aspx">Back</a>
                    </h4>
                </td>
            </tr>
            <tr>
