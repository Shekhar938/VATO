<%@ Page Language="C#" MasterPageFile="~/Members/MembersMasterPage.master" AutoEventWireup="true"
    CodeFile="frmOutBox.aspx.cs" Inherits="Members_frmOutBox" Title="Untitled Page" %>
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView ID="GridInboxdetails" Width="100%" runat="server" CellPadding="4" ForeColor="#333333"
                                            ...
                                            OnRowDataBound="GridInboxdetails_RowDataBound" EmptyDataText="No Emails " OnSelectedIndexChanged="GridInboxdetails_SelectedIndexChanged">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ControlStyle-Width="20%" HeaderText="ReceiverName">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="linkSendername" ForeColor="black" runat="server" Text='<%#Eval("UserName") %>'
                                                ...
                                                <asp:TemplateField ControlStyle-Width="50%" ItemStyle-Width="50%" HeaderText="Subject">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="linksubject" runat="server" ForeColor="black" Text='<%#Eval("emailsubjecttext") %>'
                                                            CommandArgument='<%#Eval("EmailId") %>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField ControlStyle-Width="25%" HeaderText="Date">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="linkDate" runat="server" ForeColor="black" Text='<%#Eval("Date") %>'
                                                            CommandArgument='<%#Eval("EmailId") %>'></asp:LinkButton>
                                                    </ItemTemplate>
